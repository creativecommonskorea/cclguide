...
**<span style="color:#499100"> 본인의 저작물에 CC 라이선스를 적용하기 위해서는, 우선 6 종류의 CC 라이선스들 중 본인의 저작물을 이용하기 따라야 할 이용허락조건들로 구성된 CC 라이선스를 선택합니다. &nbsp; 그 다음 아래 '라이선스 기본 표기 가이드'를 참고하여, 선택한 CC 라이선스를 저작물에 표기합니다. 이때 저작물의 콘텐츠 종류에 따라 적합한 표기 방식들이 다를 수 있기 때문에 이 페이지의 '콘텐츠 종류별 표기 상세 가이드'를 참고하여주시기 바랍니다.</span>** 
